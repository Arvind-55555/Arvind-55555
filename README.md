...
I have hands-on experience in creating **data-driven architectures** — from ingestion and transformation to **model training and deployment** using tools like **Docker, FastAPI, LangChain, and cloud-native services**.
...
- RAG and LLM-based AI applications  
- GeoAI and environmental data projects  
- Real-time data engineering and analytics systems  
